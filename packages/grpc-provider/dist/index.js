...
var _GrpcProvider_instances, _GrpcProvider_defaultConnectionSettings, _GrpcProvider_connectionSettings, _GrpcProvider_proto, _GrpcProvider_client, _GrpcProvider_package, _GrpcProvider_loadProto;
...
_GrpcProvider_defaultConnectionSettings = new WeakMap(), _GrpcProvider_connectionSettings = new WeakMap(), _GrpcProvider_proto = new WeakMap(), _GrpcProvider_client = new WeakMap(), _GrpcProvider_package = new WeakMap(), _GrpcProvider_instances = new WeakSet(), _GrpcProvider_loadProto = function _GrpcProvider_loadProto(path) {
